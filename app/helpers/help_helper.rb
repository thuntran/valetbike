module HelpHelper
    def faq! 
        ...
        faqList[2] = ["Are there any restricted areas I can't go to with ValetBike?", "There are no restrictions as to where to bike, but make sure that a station is at most 30 minutes away from the furthest point you go. If you bike outside the Valet area and don't return the bike, you will pay a fee of $400."]
        faqList[3] = ["How can I check my bike's battery?", "Bike's batteries are listed on the station map page of ValetBike. You can also check the battery through the small screen on your bike."]
